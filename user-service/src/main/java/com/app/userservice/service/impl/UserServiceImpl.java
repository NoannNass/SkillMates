...
public class UserServiceImpl implements UserService {
    ...
    public User updateInterests(String userId, List<InterestTag> interests) {
        User user = getUserById(userId)
            .orElseThrow(() -> new IllegalArgumentException("Utilisateur non trouvé avec l'ID: " + userId));
    ...
    public User updateLearningObjectives(String userId, List<LearningObjective> objectives) {
        User user = getUserById(userId)
            .orElseThrow(() -> new IllegalArgumentException("Utilisateur non trouvé avec l'ID: " + userId));
        ...
        // Mettre à jour le statut de complétion
        if (user.getCompletionStatus() == ProfileCompletionStatus.INTERESTS_COMPLETED) {
            user.setCompletionStatus(ProfileCompletionStatus.COMPLETED);
        }
    ...
    public ProfileCompletionStatus getProfileCompletionStatus(String userId) {
        ...
        return user.getCompletionStatus();
    }
    ...
    public User updateUser(String id, User userProfile) {
        ...
        if (userProfile.getCreateAt() == null) {
            userProfile.setCreateAt(currentUser.getCreateAt());
        }
    ...
    private void processSkills(User userProfile) {
    ...
    private void processInterests(User userProfile) {
    ...
    private void processLearningObjectives(User userProfile) {
